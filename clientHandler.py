...
# Server-Client Functions
    ...
    #   client = ClientHandle(user="Alice")


    #    client._ClientHandle__commands("upload", "file1.txt", file_size=10 * 1024 * 1024)  # 10 MB
    #    client._ClientHandle__commands("download", "file2.txt", file_size=5 * 1024 * 1024)  # 5 MB
